...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('src/library/lightbox/lightbox.min.css') }}">
...
<body>
  ...
  <script src="{{ asset('src/library/lightbox/lightbox-plus-jquery.min.js') }}"></script>
  <script src="{{ asset('src/library/lightbox/lightbox.min.js') }}"></script>
